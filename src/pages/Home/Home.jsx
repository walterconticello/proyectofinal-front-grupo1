      ...
      <div className="searchContainer mt-1 mb-1 p-2">
        ...
        <div className="complexCards container mx-auto p-5">
          <div className="grid gap-4 justify-center md:grid-cols-3">
            <div className="card-home-fields p-3">
              <img
              ...
              <div className="card-body">
                ...
                <p className="card-text">La mas grande del norte Argentino.</p>
            ...
            <div className="card-home-fields p-3">
              ...
              <div className="card-body">
                ...
                <p className="card-text">La mas picante del pais.</p>
                <Link to={"/complejos"} className="btn btn-primary">
                  Alquilar!
                </Link>
              </div>
            ...
            <div className="card-home-fields p-3">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Juega sin limites!.</p>
                <Link to={"/complejos"} className="btn btn-primary">
                  Alquilar!
                </Link>
              </div>
