...
const NewComment = ({
  ...
  const commentSchema = Yup.object().shape({
    ...
    rating: Yup.number()
      ...
      .min(0, "Rating muy corto")
      .max(10, "Rating muy largo"),
          ...
          >
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                className={`newcomment-text ${clsx(
                  "form-control",
                  {
            ...
            <Form.Group className="mb-3 calificanos">
              ...
              >
                ...
                <label htmlFor="star8" className="full"></label>
                <input type="radio" id="star7" name="rating" value="7" />
                <label htmlFor="star7" className="half"></label>
                <input type="radio" id="star6" name="rating" value="6" />
                <label htmlFor="star6" className="full"></label>
